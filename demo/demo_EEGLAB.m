...
TF1 = nf_tftransform(EEG,'plt',1,'freqs',foi,'times',toi,...
    'method', 'stft');               %matlab spectrogram (STFT)
TF2 = nf_tftransform(EEG,'plt',1,'freqs',foi,'times',toi,...
    'method','filterhilbert');      %filter-Hilbert
TF3 = nf_tftransform(EEG,'plt',1,'freqs',foi,'times',toi,...
    'method', 'demodulation');        %complex demodulation
TF4 = nf_tftransform(EEG,'plt',1,'freqs',foi,'times',toi,...
    'method',  'wavelet');           %Morlet discretized wavelet
TF5 = nf_tftransform(EEG,'plt',1,'freqs',foi,'times',toi,...
    'method',  'cwt');                  %Continuous Wavelet Transform
TF6 = nf_tftransform(EEG,'plt',1,'freqs',foi,'times',toi,...
    'method',  'stransform');           %Stockwell Transform
%Second Class: Quadratic Distributions
TF7 = nf_tftransform(EEG,'plt',1,'freqs',foi,'times',toi,...
    'method',  'ridbinomial', 'kernel', .4);        %Type-II Binomial RID
TF8 = nf_tftransform(EEG,'plt',1,'freqs',foi,'times',toi,...
    'method',  'ridbornjordan');      %Type-II Born-Jordan RID
TF9 = nf_tftransform(EEG,'plt',1,'freqs',foi,'times',toi,...
